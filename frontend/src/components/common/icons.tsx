...
export const BrainCircuitIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12 5a3 3 0 1 0-5.993.134" /><path d="M12 5a3 3 0 1 0 5.993.134" /><path d="M12 19a3 3 0 1 0-5.993-.134" /><path d="M12 19a3 3 0 1 0 5.993-.134" /><path d="M20 12a3 3 0 1 0-5.993.134" /><path d="M4 12a3 3 0 1 0 5.993.134" /><path d="M12 5a3 3 0 1 0-5.993.134" /><path d="M14.503 16.491a3 3 0 1 0-4.996.018" /><path d="M14.503 7.509a3 3 0 1 0-4.996-.018" /><path d="m12 12-2.5 2.5" /><path d="m14.5 9.5-2.5 2.5" /><path d="m12 12-2.5-2.5" /><path d="m14.5 14.5-2.5-2.5" />
  </svg>
);
...
export const SparklesIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12 3l1.665 5.125L19 9.5l-5.335 1.375L12 16l-1.665-5.125L5 9.5l5.335-1.375L12 3z" />
    <path d="M12 12l1.665 5.125L19 18.5l-5.335 1.375L12 25l-1.665-5.125L5 18.5l5.335-1.375L12 12z" />
  </svg>
);
...
export const LeafIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M12 3c5.5 2.5 5.5 8.5 0 11" />
    <path d="M18 3c5.5 2.5 5.5 8.5 0 11" />
  </svg>
);
...
export const MicroscopeIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M7 18V8a5 5 0 0 1 10 0v10" />
    <path d="M5 12h2" />
    <path d="M17 12h2" />
  </svg>
);
...
export const UsersIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="m22 21-2-2a4 4 0 0 0-4-4H14" />
    <path d="M18 9a4 4 0 0 0-4 4" />
  </svg>
);
